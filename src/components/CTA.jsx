...
const Testimonial = ({ quote, author, role }) => (
  <div className="h-full rounded-2xl border border-white/15 bg-white/5 p-6 text-white/90 backdrop-blur">
...
export default function CTA() {
  return (
    <section id="cta" className="relative z-10 mx-auto max-w-7xl px-6 pb-24 pt-10">
      ...
      {/* Final CTA */}
      <div className="mt-14 overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-br from-indigo-600/30 via-purple-600/20 to-cyan-500/20 p-8 text-white backdrop-blur">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/30 hover:opacity-95"
